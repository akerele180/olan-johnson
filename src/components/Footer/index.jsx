...
const Footer = () => {
  return (
    <footer className="bg-black text-white relative">
        ...
        <div className="md:grid md:text-center md:gap-10 grid-cols-3 items-center justify-between md:w-[70vw] mx-auto md:py-20 py-10 max-md:px-8">
        ...
        <div className="social__links uppercase">
          <ul className="md:flex items-center justify-center pb-5">
            ...
            <li className="md:px-5  max-md:px-8  max-md:leading-10">
              instagram
            </li>
            <li className="md:px-5  max-md:px-8  max-md:leading-10">
              whatsapp
        ...
        <span className="md:absolute md:top-3/4 md:-right-[40px] right__side text-[10px] text-gray-200 md:-rotate-90  max-md:block  max-md:text-center">
